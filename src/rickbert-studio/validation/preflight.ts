import type {
  ...
  ValidationIssue,
  ValidationReport,
} from "@/rickbert-studio/models";
import { ValidationReportSchema } from "@/rickbert-studio/schemas";
import {
  HOUSE_STYLE_FORBIDDEN_TERMS,
  HOUSE_STYLE_REQUIRED_TERMS,
} from "@/rickbert-studio/rules/styleRules";
import { CANONICAL_CHARACTER_ORDER } from "@/rickbert-studio/domain/characterConfigs";
import { includesAny } from "@/rickbert-studio/utils/text";
