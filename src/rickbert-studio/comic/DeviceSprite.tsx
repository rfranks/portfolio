...
export function DeviceSprite({ x, y, label = "Hanz" }: DeviceSpriteProps) {
  return (
    <Group x={x} y={y}>
      <Rect width={58} height={42} fill="#cfd7dd" stroke="#111" strokeWidth={1.3} cornerRadius={6} />
      <Rect x={6} y={6} width={46} height={13} fill="#f8fbff" stroke="#111" strokeWidth={1} cornerRadius={2} />
