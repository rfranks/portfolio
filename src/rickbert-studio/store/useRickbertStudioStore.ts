...
import {
  ...
  seededMasterPrompt,
  seededReferenceDocs,
} from "@/rickbert-studio/samples/seedContent";
import { parseStripInput } from "@/rickbert-studio/parser";
import { createValidationReport } from "@/rickbert-studio/validation";
import {
  DEFAULT_RENDER_SETTINGS,
  type RenderSettings,
} from "@/rickbert-studio/rendering/layoutEngine";

type StudioTab = "parsed" | "validation" | "render" | "characters" | "final";
