...
import getDemoData from "@/utils/talentforge/demoData";
...
export default function Settings() {
  ...
  const clearDemo = () => {
    ...
    window.localStorage.removeItem("connectorTokens");
  };

  const handleLoadDemo = () => {
    clearDemo();
    const { user, resumes, jobs } = getDemoData();
    saveUserProfile(user);
    saveResumes(resumes);
    jobs.forEach((job) => addJobApplication(job));
  };
