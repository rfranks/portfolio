      ...
      <Box sx={{ width: "100%" }}>
        ...
        >
          ...
          <AccordionDetails>
            ...
            >
              TalentForge is an advanced AI-powered tool designed to summarize PDF
        ...
        >
          ...
          <AccordionDetails>
            <Typography
              ...
              sx={{ maxWidth: { sm: "100%", md: "70%" } }}
            >
              TalentForge dramatically reduces the time spent reading and
        ...
        >
          ...
          <AccordionDetails>
            <Typography
              ...
              sx={{ maxWidth: { sm: "100%", md: "70%" } }}
            >
              TalentForge enhances understanding by allowing users to ask specific
        ...
        >
          ...
          <AccordionDetails>
            <Typography
              ...
              sx={{ maxWidth: { sm: "100%", md: "70%" } }}
            >
              Yes, TalentForge is designed to be accessible anywhere and anytime.
        ...
        >
          ...
          <AccordionDetails>
            <Typography
              ...
              sx={{ maxWidth: { sm: "100%", md: "70%" } }}
            >
              TalentForge is beneficial for students, professionals, and anyone who
        ...
        >
          ...
          <AccordionDetails>
            <Typography
              ...
              sx={{ maxWidth: { sm: "100%", md: "70%" } }}
            >
              Yes, TalentForge is versatile and can handle various types of PDF
        ...
        >
          ...
          <AccordionDetails>
            <Typography
              ...
              sx={{ maxWidth: { sm: "100%", md: "70%" } }}
            >
              Yes, TalentForge offers an intuitive, user-friendly interface that is
        ...
        >
          ...
          <AccordionDetails>
            <Typography
              ...
              sx={{ maxWidth: { sm: "100%", md: "70%" } }}
            >
              No, TalentForge is a web-based application that does not require any
        ...
        >
          ...
          <AccordionDetails>
            <Typography
              ...
              sx={{ maxWidth: { sm: "100%", md: "70%" } }}
            >
              Yes, TalentForge takes user privacy and data security seriously. It
              uses encryption and other security measures to protect user data
              and ensure confidentiality while handling PDF documents.
              Additionally, TalentForge does not store uploaded documents after
              processing.
            </Typography>
          </AccordionDetails>
        </Accordion>
        ...
        >
          ...
          <AccordionDetails>
            <Typography
              ...
              sx={{ maxWidth: { sm: "100%", md: "70%" } }}
            >
              Currently, TalentForge is primarily designed for individual use.
