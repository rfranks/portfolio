      ...
      MuiCssBaseline: {
        styleOverrides: {
          body: {
            ...
            "--fabric-surface-3": "var(--dna-surface-3)",
            "--fabric-surface-border": "var(--dna-surface-border)",
            "--fabric-surface-border-strong": "var(--dna-surface-border-strong)",
            "--fabric-shadow-soft": "var(--dna-shadow-soft)",
            "--fabric-shadow-tight": "var(--dna-shadow-tight)",
            "--fabric-inner-glow": "var(--dna-inner-glow)",
            "--fabric-blur-sm": "16px",
            "--fabric-blur-md": "24px",
            "--fabric-radius-lg": "16px",
            "--fabric-radius-xl": "20px",
